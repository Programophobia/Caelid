...
class Products {
 ...
 initAccordion(){
  const thisProduct = this;
  /* find the clickable trigger (the element that should react 
to clicking) */
  const clickableTrigger = thisProduct.element.querySelector(select.menuProduct.clickable)
  /* START: add event listener to clickable trigger on event 
click */
...
event.preventDefault()
    ...
    /* if there is active product and it's not 
    
thisProduct.element, remove class active from it */
