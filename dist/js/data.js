    ...
    params: {
      coffee: {
        ...
        options: {
          ...
          cappuccino: {label: 'Cappuccino', price: 3},
          espresso: {label: 'Espresso', price: 2},
          macchiato : {label: 'Macchiato ', price: 5},
        },
      },
    },
  },
    ...
    params: {
      ingredients: {
        ...
        options: {
          ...
          tomatoes: {label: 'Tomatoes', price: 0, default: true},
          olives: {label: 'Olives', price: 3, default: true},
          feta: {label: 'Feta cheese', price: 2.5},
          cheese: {label: 'Cheese', price: 2},
          herbs: {label: 'Fresh herbs', price: 1, default: true},
          pepper: {label: 'Black pepper', price: 4},
        },
      },
    },
  },
